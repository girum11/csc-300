...
% (highlight these codes and make subsections for each code reference. Make the substitutions as well for each of the sections and you're fucking golden for the rest of the paper. Just make sure that the substitutions are relevant to the research question.)
